---
name: skill-writing
description: "Create, rewrite, or review a skill (SKILL.md) file. Use when: authoring or refactoring a skill; a skill reads like a step-by-step SOP; defining testable acceptance criteria, boundaries, or a known-pitfalls section. Principles: result-determinism over process, enabling guidance not SOP, and pitfalls from real failures only. Not for: general coding tasks or runtime debugging."
---
