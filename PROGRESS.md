...
1. **Phase 3a+ — productionize company-name normalization before 3b Agent.**
   ...
   - Recommended production sequence: `fetch_openfda.py --since auto` → apply firm-resolution audit DDL → `src/firm/resolve.py --mode incremental --verification-policy web --web-model deepseek/deepseek-v4-pro --apply`.
